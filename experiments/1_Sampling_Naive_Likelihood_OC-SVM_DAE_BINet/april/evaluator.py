...
class Evaluator(object):
    ...
    @property
    def dataset(self):
        print('april-evaluator-dataset')
        if self._dataset is None:
            print('april-evaluator-datase self._dataset is None')
...
#                 p, r, f, s = metrics.precision_recall_fscore_support(yt.compressed(), yp.compressed(), average='macro')
                p, r, f, s = metrics.precision_recall_fscore_support(yt.compressed(), yp.compressed())
