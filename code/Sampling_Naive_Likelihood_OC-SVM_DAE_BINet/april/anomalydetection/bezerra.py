...
class SamplingAnomalyDetector(AnomalyDetector):
    ...
    def fit(self, dataset, s=0.7):
        ...
        print("+++++++SamplingAnomalyDetector fit idx=",idx)
        print("+++++++SamplingAnomalyDetector fit dataset.features[0][idx].shape=", dataset.features[0][idx].shape)
    ...
    def detect(self, dataset):
        ...
        scores = np.zeros_like(dataset.binary_targets)
        print("+++++++SamplingAnomalyDetector detect candidates=",candidates)
        print("+++++++SamplingAnomalyDetector detect dataset.features[0][candidates].shape=", dataset.features[0][candidates].shape)
